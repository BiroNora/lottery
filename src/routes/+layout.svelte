      ...
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
        <li>
          <a href="/" class="font-poppins block py-2 px-3 text-gray-100 md:hover:text-pink-400" aria-current="page">
				...
				<li>
          <a href="/five" class="font-poppins block py-2 px-3 text-gray-100 md:hover:text-lime-300" aria-current="page">
						Pick 5</a>
        </li>
				<li>
          <a href="/six" class="font-poppins block py-2 px-3 text-gray-100 md:hover:text-lime-300" aria-current="page">
						Pick 6</a>
        </li>
      </ul>
    </div>
